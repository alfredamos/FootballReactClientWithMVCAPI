...
export const DeleteLeague = (props) => {
                    ...
                    <form onSubmit={deleteClick}>
                        <div className="border">
                            <div className="card-body">
                                <fieldset className="form-group">
                                    ...
                                    <legend className="border-bottom m-2">Delete League</legend>
                                    <h2>Are you sure you want to delete : "{league.name}"?</h2>
...

                        {
                            isDelete && < ConfirmDelete
                                ConfirmationMessage={`Are you sure you want to delete ${league.name}?`}
